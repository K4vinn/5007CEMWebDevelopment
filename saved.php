...
<html>
    ...
    <a href='index.php'> <h1 class='page-title'> The Pictr. Club </h1> </a>
        ...
        <div class="container">
            ...
            $res2 = mysqli_query($conn, $getimages);

            $newsql = "SELECT * FROM user";
            $results = mysqli_query($conn, $sql);

            if (mysqli_num_rows($res2)  > 0) {
                while ($images = mysqli_fetch_assoc($res2)) {
                        ...
                        while ($saved = mysqli_fetch_assoc($res)) {
                            ...
                            <div class='pContainer'>
                                <div class='pictureContainer'>
                                    <div class="picture">
                                        <a href="details.php?uploads/link?id=<?= $saved['savephotoid'] ?>"> <img class='item' src="uploads/<?= $saved['photourl'] ?>"> </a>
                                    </div>
                                </div>
                            </div>
                            <?php
